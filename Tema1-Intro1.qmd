...
Todo el código de R está disponible como software [libre](https://es.wikipedia.org/wiki/Software_libre) bajo las condiciones de [licencia GNU-GPL{target="_blank"}](https://es.wikipedia.org/wiki/GNU_General_Public_License). Esto implica que cualquier usuario final puede **usar, estudiar, compartir (copiar) y modificar el software**.
