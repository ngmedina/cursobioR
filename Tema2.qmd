...
filter(alberta, Antennaria_parvifolia > 0)

# 2. Filtrar parcelas con Artemisia_frigida > 20
filter(alberta, Artemisia_frigida > 20)

# 3. Filtrar parcelas con Antennaria_parvifolia > 0 Y Artemisia_frigida > 20
filter(alberta, Antennaria_parvifolia > 0, Artemisia_frigida > 20)
...
::: {style="display:none; margin-top:10px; border:1px solid #ccc; padding:10px; border-radius:5px;"}
Solución:\
