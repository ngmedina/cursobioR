...
En la próxima sesión vamos a explorar índices de biodiversidad. Para ello vamos a emplear bases de datos de la abundancia de especies en herbazales de Alberta en Estados Unidos con el que ya estáis familiarizados. La base de datos original podéis descargarla [aquí](https://kembellab.ca/r-workshop/)
...
Siempre que os enfrentéis a una función nueva conviene explorar la ayuda y ver los ejemplos
...
#### Ejercicio 3: ¿Qué contiene el objeto dummy?
...
Ahora comparemos esa tabla con la de los rasgos de las comunidades de Alberta
...
```{webr-r}
Los nombres de las especies estén como **nombres de filas** en dummy mientras que en la tabla traits aparece como columna
```
:::
...
Hacemos lo mismo con la tabla de abundancia
